...
const userBirthdayInput = document.querySelector('#birthday') as HTMLInputElement;
...
function displayUserName() {
  const nameDisplay = document.querySelector('.user-name') as HTMLSpanElement;
...
function displayUserZodiacSign() {
  ...
  const {
    ...
    isAquariusDate,
    isPiscesDate,
  } = getZodiacSign(userBirthdayInput);
...
function displayZodiacSign(zodiacSignName: string, zodiacSignImg: string) {
  const zodiacSignDisplay = document.querySelector('.zodiac-sign') as HTMLSpanElement;
  const zodiacSignImageElement = document.querySelector('.zodiac-sign-image') as HTMLImageElement;

  zodiacSignDisplay.textContent = zodiacSignName;
  zodiacSignImageElement.src = zodiacSignImg;
}

function displayValidationError(inputField: HTMLInputElement, message: string) {
  const nameContentContainer = document.querySelector('.name-content') as HTMLElement;
...
function clearErrorMessages() {
  const errorMessages = Array.from(document.querySelectorAll('.error-message')) as HTMLInputElement[];
